...
constexpr AppLauncherIcon::Data STYLESHEET_410_502_DARK_APP_LAUNCHER_ICON_DATA = {
    .main = {
        .size = gui::StyleSize::SQUARE(92),
        .layout_row_pad = 4,
    },
    .image = {
        .default_size = gui::StyleSize::SQUARE(60),
        .press_size = gui::StyleSize::SQUARE(54),
    },
    .label = {
...
constexpr AppLauncherData STYLESHEET_410_502_DARK_APP_LAUNCHER_DATA = {
    ...
    .table = {
        .default_num = 1,
        .size = gui::StyleSize::RECT_PERCENT(100, 86),
    },
    .indicator = {
        .main_size = gui::StyleSize::RECT_W_PERCENT(100, 14),
        .main_layout_column_pad = 6,
        .main_layout_bottom_offset = 12,
        .spot_inactive_size = gui::StyleSize::SQUARE(8),
        .spot_active_size = gui::StyleSize::RECT(28, 8),
