...
private:
    ...
    static void storageStatusTask(void *arg);
    static void sdFormatTask(void *arg);
    static void healthStatusTask(void *arg);
    static void sensorStatusTask(void *arg);

    void refreshStatus(bool include_storage = true);
    void requestStorageRefresh(bool force = false);
    void requestDiagnosticsRefresh(bool force = false);
    ...
    static constexpr int POWER_RANK_LABELS = 5;
    ...
    lv_obj_t *_battery_percent_label = nullptr;
    lv_obj_t *_battery_fill = nullptr;
    lv_obj_t *_power_cycle_label = nullptr;
    lv_obj_t *_power_chart = nullptr;
    lv_chart_series_t *_power_discharge_series = nullptr;
    lv_chart_series_t *_power_charge_series = nullptr;
    lv_obj_t *_power_chart_detail_label = nullptr;
    lv_obj_t *_power_rank_title_label = nullptr;
    lv_obj_t *_power_rank_labels[POWER_RANK_LABELS] = {};
    ...
    TaskHandle_t _storage_status_task = nullptr;
    TaskHandle_t _sd_format_task = nullptr;
    TaskHandle_t _health_status_task = nullptr;
    TaskHandle_t _sensor_status_task = nullptr;
    ...
    char _storage_status_text[560] = "Storage status not loaded.";
    char _health_status_text[1400] = "Health status not loaded.";
    char _sensor_status_text[768] = "Sensor status not loaded.";
    ...
    bool _storage_status_dirty = true;
    bool _storage_status_error = false;
    bool _health_status_dirty = true;
    bool _sensor_status_dirty = true;
    bool _sd_format_armed = false;
    uint32_t _storage_refresh_tick = 0;
    uint32_t _storage_retry_interval_ms = 60000;
    uint32_t _diagnostics_refresh_tick = 0;
    uint32_t _page_generation = 0;
    int64_t _sd_format_last_ms = 0;
    int _pending_screen_timeout_s = 0;
};
