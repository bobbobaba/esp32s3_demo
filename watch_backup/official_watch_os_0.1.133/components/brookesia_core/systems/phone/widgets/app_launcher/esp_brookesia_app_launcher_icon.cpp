...
extern const lv_font_t lv_font_watch_zh_14;
...
namespace {
bool has_non_ascii(const char *text)
{
...
bool AppLauncherIcon::begin(lv_obj_t *parent)
{
    ...
    lv_obj_set_style_radius(icon_main_obj.get(), 16, 0);
    lv_obj_set_style_bg_color(icon_main_obj.get(), lv_color_hex(0x15171D), 0);
    lv_obj_set_style_bg_opa(icon_main_obj.get(), LV_OPA_COVER, 0);
    lv_obj_set_style_border_width(icon_main_obj.get(), 1, 0);
    lv_obj_set_style_border_color(icon_main_obj.get(), lv_color_hex(0x2B303A), 0);
    ...
    lv_label_set_long_mode(name_label.get(), LV_LABEL_LONG_DOT);
...
bool AppLauncherIcon::updateByNewData(void)
{
    ...
    // Label
    lv_obj_set_size(_name_label.get(), _data.main.size.width, 18);
    lv_obj_set_style_text_align(_name_label.get(), LV_TEXT_ALIGN_CENTER, 0);
    lv_obj_set_style_text_font(
        _name_label.get(),
        has_non_ascii(_info.name) ? &lv_font_watch_zh_14 : (lv_font_t *)_data.label.text_font.font_resource,
        0
    );
...
void AppLauncherIcon::onIconTouchEventCallback(lv_event_t *event)
{
    ...
    case LV_EVENT_PRESSED:
        ...
        lv_obj_set_style_bg_color(icon->_icon_main_obj.get(), lv_color_hex(0x202632), 0);
        lv_obj_set_style_border_color(icon->_icon_main_obj.get(), lv_color_hex(0x3B4657), 0);
    ...
    case LV_EVENT_RELEASED:
        ...
        lv_obj_set_style_bg_color(icon->_icon_main_obj.get(), lv_color_hex(0x15171D), 0);
        lv_obj_set_style_border_color(icon->_icon_main_obj.get(), lv_color_hex(0x2B303A), 0);
        lv_obj_refr_size(icon_image_obj);
        break;
    default:
