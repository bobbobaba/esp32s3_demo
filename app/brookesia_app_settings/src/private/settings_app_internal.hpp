...
inline constexpr const char *PAGE_DIAGNOSTIC = "diagnostic";
...
inline constexpr const char *ACTION_OPEN_DIAGNOSTIC = "settings.open.diagnostic";
inline constexpr const char *ACTION_BACK_DIAGNOSTIC = "settings.back.diagnostic";
...
inline constexpr const char *DIAGNOSTIC_SYSTEM_NAME_PATH = "/diagnostic/page/overview/system/value";
inline constexpr const char *DIAGNOSTIC_FIRMWARE_PATH = "/diagnostic/page/overview/firmware/value";
inline constexpr const char *DIAGNOSTIC_RESET_REASON_PATH = "/diagnostic/page/overview/reset_reason/value";
inline constexpr const char *DIAGNOSTIC_HEAP_PATH = "/diagnostic/page/memory_card/heap/value";
inline constexpr const char *DIAGNOSTIC_PSRAM_PATH = "/diagnostic/page/memory_card/psram/value";
inline constexpr const char *DIAGNOSTIC_WIFI_PATH = "/diagnostic/page/connectivity_card/wifi/value";
inline constexpr const char *DIAGNOSTIC_OTA_PATH = "/diagnostic/page/connectivity_card/ota/value";
inline constexpr const char *DIAGNOSTIC_BATTERY_PATH = "/diagnostic/page/power_card/battery/value";
inline constexpr const char *DIAGNOSTIC_POWER_PATH = "/diagnostic/page/power_card/source/value";
inline constexpr const char *DIAGNOSTIC_APP_PATH = "/diagnostic/page/runtime_card/app/value";
inline constexpr const char *DIAGNOSTIC_TASK_PATH = "/diagnostic/page/runtime_card/task/value";
