...
static constexpr const char *PAGE_MORE = "more";
    ...
    static constexpr const char *PAGE_DIAGNOSTIC = "diagnostic";
...
static constexpr const char *ACTION_BACK_LANGUAGE = "settings.back.language";
    ...
    static constexpr const char *ACTION_OPEN_DIAGNOSTIC = "settings.open.diagnostic";
    static constexpr const char *ACTION_BACK_DIAGNOSTIC = "settings.back.diagnostic";
...
std::string make_app_version()
{
    ...
    NavigationTarget{"settings.open.language", PAGE_LANGUAGE},
        ...
        NavigationTarget{ACTION_OPEN_DIAGNOSTIC, PAGE_DIAGNOSTIC},
    };
...
std::string_view get_header_back_action_for_page(std::string_view page)
{
    ...
    if (page == PAGE_DIAGNOSTIC) {
        return ACTION_BACK_DIAGNOSTIC;
    }
    if (page == PAGE_DEVICE) {
