...
target_link_libraries(${COMPONENT_LIB} PUBLIC "-u app_watch_ota_provider_symbol")

set(app_watch_ota_package_id "bo.watch.ota")
...
brookesia_system_core_get_esp_runtime_app_stage_root(app_watch_ota_stage_root)
brookesia_stage_runtime_app_package(
    PACKAGE_ID "${app_watch_ota_package_id}"
    SOURCE_DIR "${COMPONENT_DIR}/package"
    STAGE_ROOT "${app_watch_ota_stage_root}"
    NO_INDEX
)
