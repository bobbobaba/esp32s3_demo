...
constexpr const char *CONFIG_URL = "<PRIVATE_OTA_BASE_URL>/api/v1/device-config";
constexpr const char *STATUS_URL = "<PRIVATE_OTA_BASE_URL>/api/v1/device-status";
...
void OtaApp::runOperation(Operation operation)
{
    ...
    if (_token[0] == '\0') {
        ...
        setDetail("State: login private OTA backend");
