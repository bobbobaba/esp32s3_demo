...
extern "C" {
extern const lv_font_t lv_font_watch_zh_16;
extern const lv_font_t lv_font_watch_zh_28;
...
const lv_font_t *get_builtin_font(int32_t font_size)
{
    ...
    // Watch-specific embedded Chinese fallback. The LVGL bundled Source Han
    // 14/16 CJK subsets do not include several app launcher glyphs such as
    // "应/设/器/乐/播/拟". Prefer the project-generated watch subsets first.
    if (font_size <= 24) {
        return &lv_font_watch_zh_16;
    }
    if (font_size > 24 && font_size <= 48) {
        return &lv_font_watch_zh_28;
    }
