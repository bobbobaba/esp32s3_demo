...
inline constexpr const char *SUPER_HOME_CLOCK_PATH = BROOKESIA_SYSTEM_SUPER_PATH_HOME "/face/clock";
inline constexpr const char *SUPER_HOME_DATE_PATH = BROOKESIA_SYSTEM_SUPER_PATH_HOME "/face/date";
inline constexpr const char *SUPER_HOME_WIFI_PATH = BROOKESIA_SYSTEM_SUPER_PATH_HOME "/face/top_status/right_status/wifi";
inline constexpr const char *SUPER_HOME_WIFI_LABEL_PATH =
    BROOKESIA_SYSTEM_SUPER_PATH_HOME "/face/top_status/right_status/wifi/label";
inline constexpr const char *SUPER_HOME_BATTERY_PATH =
    BROOKESIA_SYSTEM_SUPER_PATH_HOME "/face/top_status/right_status/battery";
inline constexpr const char *SUPER_HOME_BATTERY_LABEL_PATH =
    BROOKESIA_SYSTEM_SUPER_PATH_HOME "/face/top_status/right_status/battery/label";
...
inline constexpr const char *SUPER_STATUS_BATTERY_TIMER_NAME = "super.status.battery";
