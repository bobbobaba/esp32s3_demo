...
private:
    ...
    void set_status_battery_state(const service::helper::Device::PowerBatteryState &state);
    void set_status_battery_unknown();
    void schedule_battery_status_timer();
    void stop_battery_status_timer();
    ...
    uint64_t battery_status_generation_ = 0;
    ...
    ShellPage current_shell_page_ = ShellPage::Home;
    ...
    core::TimerId battery_status_timer_id_ = core::INVALID_TIMER_ID;
